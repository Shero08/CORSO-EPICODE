...
const SingleBook = (props) => {
  ...
  return (
    <div 
      key={props.asin} 
      className="group bg-white rounded-lg py-2 px-2 shadow cursor-pointer transition-transform hover:-translate-y-1 hover:shadow-gray-600 hover:shadow-md"
