...
const SingleBook = (props) => {
    ...
    useEffect(() => {}, [dispatch, selectCardState])
    ...
    return (
        <div
            ...
            className={`bg-white rounded-lg py-2 px-2 shadow cursor-pointer transition-transform hover:-translate-y-1 hover:shadow-gray-600 hover:shadow-md ${
                selectCardState === props.asin
                    ? 'selected border-solid border-4 border-red-600'
                    : ''
            }`}
        >
