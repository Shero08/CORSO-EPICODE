...
const AddComment = ({bookID}) => {
    ...
    const token =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2M2RhYjg0ODJiMDAxNTAwMTU5YThiNjgiLCJpYXQiOjE2NzgzMTI1NjAsImV4cCI6MTY3OTUyMjE2MH0.CX0fpBVX_WZjYsCMH15nH1F1fiLsvON-gvzbDZi7K_w'
